...
// Importe suas entidades e repositórios
// Os pacotes podem variar dependendo da estrutura do seu projeto
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        genghisCore.setCore_systems_name("Lucifer-Class NHP");
        genghisCore.setActive_name("Total System Meltdown");
        genghisCore.setActive_effect("Imediatamente após usar o Sistema Principal, você pode se mover até sua velocidade e fazer um ataque com uma única arma. Este ataque causa +1d6 de dano de bônus.");
        genghisCore.setUse("1/missão");
        genghisCore.setActivation("Ação Rápida");
        genghisCore.setActive_synergies(Collections.singletonList(luciferno));
        genghisCore.setIntegrated(Arrays.asList("Aux/Aux", "Flexível", "Principal/Aux"));
        ...
        CoreSystem chom_cs = new CoreSystem();
        chom_cs.setCore_systems_name("Karakoram-Class NHP");
        chom_cs.setActive_name("CHOMOLUNGMA PROTOCOL");
        chom_cs.setActive_effect("Ao ativar, o mech ganha resistência a todos os danos até o final da cena. Além disso, uma vez por rodada, pode realizar um teste de SISTEMAS para reforçar um aliado, concedendo-lhe resistência a um tipo de dano por uma rodada.");
        chom_cs.setUse("1/missão");
        chom_cs.setActivation("Ação Rápida");
        chom_cs.setActive_synergies(Collections.emptyList());
        chom_cs.setIntegrated(Arrays.asList("Flexível","Flexível","Flexível"));
        ...
        CoreSystem eve_cs = new CoreSystem();
        eve_cs.setCore_systems_name("Everest-Class NHP");
        eve_cs.setActive_name("CORE POWER");
        eve_cs.setActive_effect("Ao ativar, o piloto pode escolher um dos três benefícios para a cena: +2 de dano em todos os ataques, +2 de VELOCIDADE e EVASÃO, ou limpar todo o CALOR e se tornar imune ao superaquecimento.");
        eve_cs.setUse("1/missão");
        eve_cs.setActivation("Ação Rápida");
        eve_cs.setActive_synergies(Collections.emptyList());
        eve_cs.setIntegrated(Arrays.asList("Principal","Flexível","Flexível"));
        ...
        CoreSystem sag_cs = new CoreSystem();
        sag_cs.setCore_systems_name("Tenzing-Class NHP");
        sag_cs.setActive_name("SAGARMATHA PROTOCOL");
        sag_cs.setActive_effect("Ao ativar, o mech projeta um campo de força em um cone de 5. Aliados dentro do campo ganham cobertura pesada e resistência a danos de fontes fora do campo. O mech pode manter este campo como uma ação rápida em seus turnos.");
        sag_cs.setUse("1/missão");
        sag_cs.setActivation("Ação Rápida");
        sag_cs.setActive_synergies(Collections.emptyList());
        sag_cs.setIntegrated(Arrays.asList("Pesado","Flexível"));
        ...
        CoreSystem bb_cs = new CoreSystem();
        bb_cs.setCore_systems_name("Chain-Class NHP");
        bb_cs.setActive_name("GRAPPLE AND PULL");
        bb_cs.setActive_effect("O mech pode disparar até dois ganchos em alvos dentro do alcance do sensor. Os alvos devem ter sucesso em um teste de ENGENHARIA ou são puxados para espaços adjacentes ao mech e ficam imobilizados e agarrados.");
        bb_cs.setUse("1/missão");
        bb_cs.setActivation("Ação Completa");
        bb_cs.setActive_synergies(Collections.emptyList());
        bb_cs.setIntegrated(Arrays.asList("Principal/Aux","Principal/Aux"));
        ...
        CoreSystem drake_cs = new CoreSystem();
        drake_cs.setCore_systems_name("Leviathan-Class NHP");
        drake_cs.setActive_name("AEGIS PROTOCOL");
        drake_cs.setActive_effect("Ao ativar, o mech cria um campo de proteção de rajada 2 centrado em si mesmo. Aliados dentro do campo ganham resistência a todos os danos. O campo dura até o final da cena.");
        drake_cs.setUse("1/missão");
        drake_cs.setActivation("Ação Completa");
        drake_cs.setActive_synergies(Collections.emptyList());
        drake_cs.setIntegrated(Arrays.asList("Principal","Pesado"));
        ...
        CoreSystem bw_cs = new CoreSystem();
        bw_cs.setCore_systems_name("Oracle-Class NHP");
        bw_cs.setActive_name("FATE REWEAVE");
        bw_cs.setActive_effect("Ao ativar, até o final da cena, o piloto pode forçar um inimigo a rolar novamente qualquer teste de ataque, salvamento ou habilidade, ou permitir que um aliado role novamente. Esta habilidade pode ser usada uma vez por rodada.");
        bw_cs.setUse("1/missão");
        bw_cs.setActivation("Ação Rápida");
        bw_cs.setActive_synergies(Collections.emptyList());
        bw_cs.setIntegrated(Arrays.asList("Principal","Principal"));
        ...
        CoreSystem dh_cs = new CoreSystem();
        dh_cs.setCore_systems_name("Executioner-Class NHP");
        dh_cs.setActive_name("FINAL HUNT");
        dh_cs.setActive_effect("Ao ativar, o piloto marca um alvo. Por uma rodada, todos os ataques feitos por este mech contra o alvo são acertos críticos automáticos. O mech não pode atacar outros alvos nesta rodada.");
        dh_cs.setUse("1/missão");
        dh_cs.setActivation("Ação Rápida");
        dh_cs.setActive_synergies(Collections.emptyList());
        dh_cs.setIntegrated(Arrays.asList("Principal/Aux","Principal/Aux"));
        ...
        CoreSystem gob_cs = new CoreSystem();
        gob_cs.setCore_systems_name("Sisyphus-Class NHP");
        gob_cs.setActive_name("HACK THE PLANET");
        gob_cs.setActive_effect("Ao ativar, o piloto pode escolher até 3 alvos dentro do alcance do sensor. Cada alvo sofre um efeito de invasão massivo, como superaquecimento, imobilização ou desarmamento, sem a necessidade de um teste de ataque tecnológico.");
        gob_cs.setUse("1/missão");
        gob_cs.setActivation("Ação Completa");
        gob_cs.setActive_synergies(Collections.emptyList());
        gob_cs.setIntegrated(Arrays.asList("Principal/Aux"));
        ...
        CoreSystem bar_cs = new CoreSystem();
        bar_cs.setCore_systems_name("Genghis-Class NHP"); // Nota: O nome parece ser genérico, pode ser um erro de cópia. Ajuste se necessário.
        bar_cs.setActive_name("APOCALYPSE RAIL");
        bar_cs.setActive_effect("O mech dispara um tiro massivo em linha reta que ignora cobertura e causa 4d6 de dano explosivo a todos em seu caminho. O terreno na linha de fogo é destruído.");
        bar_cs.setUse("1/missão");
        bar_cs.setActivation("Ação Completa");
        bar_cs.setActive_synergies(Collections.emptyList());
        bar_cs.setIntegrated(Arrays.asList("Superpesado"));
